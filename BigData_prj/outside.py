...
#요소별 제목 폰트
Content_Font = tkinter.font.Font(family = "굴림", size=18, weight = "bold")


#시작페이지 그림
def Entrance():
    window.geometry("512x512+200+100")
    photo = tkinter.PhotoImage(file = 'C:/Users/Hajin_2/python/python/BigData_prj/Entrance.png')
    Entrance_Button = tkinter.Button(window, image = photo, command= Call_Main)
    Entrance_Button.place(x=0, y=0)

    window.mainloop()

#그림 누르면 메인페이지, 카테고리 불러옴
def Call_Main():
    Category()
    Main()
